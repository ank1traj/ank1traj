					...
					<header>
						<div class="header-wrap col-lg-10 center-div">
							...
							<div class="float-right social-download-wrap">
								<a href="../assets/files/resume.pdf" class="btn btn-default float-left">
									<span class="mask"></span>
									<span class="btn-label">
										<b>download resume</b>
					...
					<div id="main_content" class="content-block margin-top-150 margin-top-sm-70 margin-top-xs-50">
						...
						<section id="intro_content_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div intro-content-wrap sec-pad">
							...
							<p class="pad-bottom-35 wow fadeInUp" data-wow-duration=".6s">
								I am an undergraduate at the Chandigarh University working towards a Bachelor of Engineering in Computer Science, with a concentration in Python, Web Development and Ethical Hacking. In my first year at the Chandigarh University, I have engaged in multiple Projects. I am an active member of the Coding Program and Student Unions Programming Board.
							</p>
							<p class="wow fadeInUp" data-wow-duration=".4s">
								I am a complete social animal. Find my work on <a class="goto-social" href="https://www.github.com/ank1traj" target="_blank">Github</a>

							</p>
							<div class="per-signature margin-top-sm wow fadeInUp" data-wow-duration=".4s">
								<img class="img-responsive" src="img/signa.gif" alt="signature"/>
							</div>
						</section>
						<!--/Introduction Sec-->
						...
						<section id="skill_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div skills-wrap  sec-pad-top sec-pad-bottom-xs">
							...
							<div class="row margin-top-40">
								...
								<div class="col-sm-offset-1 col-sm-5 margin-bottom-sm">
									<span class="progress-cat">NodeJs</span>
									<div class="progress-bar-graph"> 
										<div class="progress-bar-wrap">
											<div class="bar-wrap">
												<span data-width="70">
								...
								<div class="clearfix"></div>
								<div class="col-sm-5 margin-bottom-sm">
									<span class="progress-cat">MongoDB</span>
									<div class="progress-bar-graph"> 
										<div class="progress-bar-wrap">
											<div class="bar-wrap">
												<span data-width="86">
								...
								<div class="col-sm-offset-1 col-sm-5 margin-bottom-sm">
									<span class="progress-cat">C/C++</span>
									<div class="progress-bar-graph"> 
										<div class="progress-bar-wrap">
											<div class="bar-wrap">
												<div class="bar-wrap">
						...
						<section id="edu_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div education-wrap  sec-pad">
							<h6>education</h6>
							<p class="wow fadeInUp" data-wow-duration=".4s">
								I spent 9 years in learning Web Design & Development, doing my Bachelor degree in Computer Science and started working independently. 
							...
							<div class="qualfication-wrap">
								<div class="qualfication first-row wow fadeInUp" data-wow-duration=".4s">
									...
									<div class="col-sm-2">
										<span class="yr-pers vertical-align-pad">2017-2021</span>
									</div>
									<div class="col-sm-5">
										<span class="insti vertical-align-pad">Chandigarh University, Chandigarh</span>
									</div>
									<div class="col-sm-3">
								...
								<div class="qualfication wow fadeInUp" data-wow-duration=".4s">
									...
									<div class="col-sm-5">
										<span class="insti vertical-align-pad">Gyan Bharti Residential Complex, Gaya</span>
									</div>
									<div class="col-sm-3">
										<span class="design vertical-align-pad">
											Senior Secondary
								...
								<div class="qualfication wow fadeInUp" data-wow-duration=".4s">
									...
									<div class="col-sm-2">
										<span class="yr-pers vertical-align-pad">2002-2014</span>
									</div>
									<div class="col-sm-5">
										<span class="insti vertical-align-pad">D.A.V Public School, Gaya</span>
									</div>
									<div class="col-sm-3">
										<span class="design vertical-align-pad">
											Secondary School
									...
									<div class="col-xs-10 exp-content-wrap">
										<div class="row">
											<div class="wow fadeInRight" data-wow-duration=".4s" data-wow-delay="0s">
												<div class="col-sm-3 duration"><span>mar 2017 - present</span></div>
												<div class="col-sm-9">
													<span class="job-desn">Web Developer</span>
													<span class="job-loc">Chandigarh University, Chandigarh
	</span>
													<p class="job-summary p-small">Designed and developed websites for the University</p>
												</div>
											</div>	
										</div>
									</div>	
									...
									<div class="col-xs-10 exp-content-wrap">
										<div class="row">
											<div class="wow fadeInRight" data-wow-duration=".4s" data-wow-delay="0.6s">
												<div class="col-sm-3 duration"><span>Mar 2016 – Present</span></div>
												<div class="col-sm-9">
													<span class="job-desn">Freelance Developer
	</span>
													<span class="job-loc">Freelancer
	</span>
													<p class="job-summary p-small">Web Developer and Designer</p>
												</div>
											</div>	
										</div>
									</div>	
									...
									<div class="col-xs-10 exp-content-wrap">
										<div class="row">
											<div class="wow fadeInRight" data-wow-duration=".4s" data-wow-delay="0.2s">
												<div class="col-sm-3 duration"><span>Jan 2018 — Mar 2018</span></div>
												<div class="col-sm-9">
													<span class="job-desn">Coordinator</span>
													<span class="job-loc">Chandigarh University
	</span>
													<p class="job-summary p-small">Work as a coordinator for the technical fest. Being in a very well structured team, with clear and defined work procedures, helped me grow both personally and professionally, as well as enjoying a young working environment.</p>
												</div>
											</div>	
										</div>
									</div>	
									...
									<div class="col-xs-10 exp-content-wrap">
										<div class="row">
											<div class="wow fadeInRight" data-wow-duration=".4s" data-wow-delay="0.4s">
												<div class="col-sm-3 duration"><span>April 2017 – Jul 2018</span></div>
												<div class="col-sm-9">
													<span class="job-desn">Web Publishing
	</span>
													<span class="job-loc">Kshitij, Patna
	</span>
													<p class="job-summary p-small">Worked as a volunteer and Web Developer and Designer. I've learned to be proficient in a fast-paced work environment.</p>
												</div>
											</div>	
										</div>
									</div>	
						...
						<section id="achivement_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div achivement-wrap  sec-pad-top sec-pad-bottom-sm">
							<h6>achivements</h6>
							<p class="wow fadeInUp" data-wow-duration=".4s">It always seems impossible until its done. Participated in more than 50 contests run online and run by government. I got first prize for IOT based challenge, the contest held in Chandigarh University.</p>
								...
								<ul class="row">
									<li class="col-sm-6">
										<ul>
											...
											<span class="achive-pts">720<sup>th</sup> world rank in cyber olympiad</span>
											</li>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".4s" data-wow-delay=".2s"><span class="dash-pointer">-</span><span class="achive-pts">879<sup>th</sup> world rank in science olympiad</span></li>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".4s" data-wow-delay=".4s"><span class="dash-pointer">-</span><span class="achive-pts">94 percentile in HackerRank algorithm</span></li>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".4s" data-wow-delay=".6s"><span class="dash-pointer">-</span><span class="achive-pts">All State Rank 159th in NSTSE.</span></li>
										</ul>
									</li>
									<li class="col-sm-6">
										<ul>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".4s" data-wow-delay="0s"><span class="dash-pointer">-</span><span class="achive-pts">395<sup>th</sup>national rank in science olympiad in 200</span></li>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".4s" data-wow-delay="0.2s"><span class="dash-pointer">-</span><span class="achive-pts">Under top 200 in CodeChef long Challenge in October 2019</span></li>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".4s" data-wow-delay=".4s"><span class="dash-pointer">-</span><span class="achive-pts">In top 3000 team in Google Hash-Code</span></li>
											<li class="margin-bottom-xs wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".6s"><span class="dash-pointer">-</span><span class="achive-pts">Qualified First round of CodeChef SnackDown 2019</span></li>
										</ul>
									</li>
								</ul>
							</div>	
						...
						<section id="contact_sec"  class="col-lg-10 col-md-11 col-sm-11 center-div contact-wrap  sec-pad-top sec-pad-bottom-sm">
							...
							<div class="email-direct">
								<p class="wow fadeInRight" data-wow-duration=".4s">Simply email me at <a href="mailto:xyz@example.com">admin@ankitraj.in</a></p>
							</div>
						</section>
						<!--Contact Sec-->
								...
								<div class="col-sm-6">
									<div class="social-icons-wrap float-right">
										...
										<ul class="social-icons float-right">
											<li>
												<a href="https://www.facebook.com/ank1traj" class="social-icon">
													<span class="fa" data-hover="&#xf09a;">&#xf09a;</span>
												</a>
											</li>
											<li>
												<a href="https://github.com/ank1traj" class="social-icon">
													<span class="fa" data-hover="&#xf09b;">&#xf113;</span>
												</a>
											</li>
											<li>
												<a href="https://www.linkedin.com/in/ank1traj" class="social-icon">
													<span class="fa" data-hover="&#xf08c;">&#xf08c;</span>
												</a>
											</li>
											<li>
												<a href="https://www.instagram.com/ank1t_shr1vastava9/" class="social-icon">
													<span class="fa" data-hover="&#xf16d;">&#xf16d;</span>
												</a>
											</li>
										</ul>
									...
									<div class="copywrite-wrap text-right float-right">
										<p class="copywrite">Fabricated by <b>Ankit Raj &copy; 2019.</b> Updated <b>November, 2019.</b></p>
									</div>
								</div>	
							</div>	
						</footer>
